...
# parameters
# 
add_parameter ADDR_BITS INTEGER 2
...
add_parameter BYTE_WIDTH INTEGER 4
set_parameter_property BYTE_WIDTH DEFAULT_VALUE 4
set_parameter_property BYTE_WIDTH DISPLAY_NAME BYTE_WIDTH
set_parameter_property BYTE_WIDTH TYPE INTEGER
set_parameter_property BYTE_WIDTH UNITS None
set_parameter_property BYTE_WIDTH HDL_PARAMETER true
...
add_interface_port mm mm_byteenable byteenable Input BYTE_WIDTH
add_interface_port mm mm_read read Input 1
add_interface_port mm mm_write write Input 1
add_interface_port mm mm_readdata readdata Output BYTE_WIDTH*8
add_interface_port mm mm_writedata writedata Input BYTE_WIDTH*8
...
add_interface_port conduit_end leds leds Output 10

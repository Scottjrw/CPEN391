...
module testhps_mm_interconnect_1 (
	...
	wire  [122:0] onchip_memory2_0_s1_agent_rp_data;                           // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [122:0] cmd_mux_src_data;                                            // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	testhps_mm_interconnect_1_router_002 router_003 (
	...
	testhps_mm_interconnect_1_router_004 router_004 (
	...
	testhps_mm_interconnect_1_cmd_demux cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testhps_mm_interconnect_1_cmd_demux cmd_demux_003 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testhps_mm_interconnect_1_rsp_mux rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testhps_mm_interconnect_1_rsp_mux rsp_mux_003 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset

...
# Memory: Video_Subsystem_Video_Frame_Buffer
MEM_0 := cpen391_group5_qsys_Video_Subsystem_Video_Frame_Buffer
$(MEM_0)_NAME := Video_Subsystem_Video_Frame_Buffer
...
$(MEM_0)_HIERARCHICAL_PATH := Video_Subsystem.Video_Frame_Buffer
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: Video_Subsystem_Video_Frame_Buffer
Video_Subsystem_Video_Frame_Buffer: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

...
project_name = 'cpen391_group5'
project_folder = '../{}/'.format(project_name)
project_bsp_folder = '../{}_bsp/'.format(project_name)
...
flags = [
    ...
    '-I'+project_bsp_folder+'/HAL/inc',
    '-I'+project_bsp_folder+'/drivers/inc',
    '-Wall',
    '-std=c11',
    '-include',
    project_folder+'/ycm.h',
    '-isystem',
    project_bsp_folder+'/HAL/inc',
    '-isystem',

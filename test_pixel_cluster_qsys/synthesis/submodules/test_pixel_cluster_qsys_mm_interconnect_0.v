// test_pixel_cluster_qsys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module test_pixel_cluster_qsys_mm_interconnect_0 (
	...
	wire  [19:0] pixel_cluster_0_mm_agent_m0_address;                                                // pixel_cluster_0_mm_agent:m0_address -> pixel_cluster_0_mm_translator:uav_address
	...
	wire  [94:0] pixel_cluster_0_mm_agent_rf_source_data;                                            // pixel_cluster_0_mm_agent:rf_source_data -> pixel_cluster_0_mm_agent_rsp_fifo:in_data
	...
	wire  [94:0] pixel_cluster_0_mm_agent_rsp_fifo_out_data;                                         // pixel_cluster_0_mm_agent_rsp_fifo:out_data -> pixel_cluster_0_mm_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> pixel_cluster_0_mm_agent:cp_valid
	wire  [93:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pixel_cluster_0_mm_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // pixel_cluster_0_mm_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pixel_cluster_0_mm_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> pixel_cluster_0_mm_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> pixel_cluster_0_mm_agent:cp_endofpacket
	...
	wire         pixel_cluster_0_mm_agent_rp_valid;                                                  // pixel_cluster_0_mm_agent:rp_valid -> router_004:sink_valid
	wire  [93:0] pixel_cluster_0_mm_agent_rp_data;                                                   // pixel_cluster_0_mm_agent:rp_data -> router_004:sink_data
	wire         pixel_cluster_0_mm_agent_rp_ready;                                                  // router_004:sink_ready -> pixel_cluster_0_mm_agent:rp_ready
	wire         pixel_cluster_0_mm_agent_rp_startofpacket;                                          // pixel_cluster_0_mm_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         pixel_cluster_0_mm_agent_rp_endofpacket;                                            // pixel_cluster_0_mm_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         pixel_cluster_0_mm_agent_rdata_fifo_src_valid;                                      // pixel_cluster_0_mm_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] pixel_cluster_0_mm_agent_rdata_fifo_src_data;                                       // pixel_cluster_0_mm_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         pixel_cluster_0_mm_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_002:in_0_ready -> pixel_cluster_0_mm_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> pixel_cluster_0_mm_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> pixel_cluster_0_mm_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // pixel_cluster_0_mm_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> pixel_cluster_0_mm_agent:rdata_fifo_sink_error
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router router (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router_001 router_001 (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router_002 router_002 (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router_003 router_003 (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router_002 router_004 (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_router_003 router_005 (
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_pixel_cluster_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),

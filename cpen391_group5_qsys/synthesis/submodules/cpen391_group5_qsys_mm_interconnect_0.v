...
module cpen391_group5_qsys_mm_interconnect_0 (
	...
	wire  [103:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_agent:rp_data
	...
	wire  [103:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_agent:rp_data
	...
	wire  [104:0] nios2_jtag_debug_module_agent_rf_source_data;                                // nios2_jtag_debug_module_agent:rf_source_data -> nios2_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [104:0] nios2_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_jtag_debug_module_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> nios2_jtag_debug_module_agent:cp_data
	...
	wire  [104:0] led_out_pio_s1_agent_rf_source_data;                                         // led_out_pio_s1_agent:rf_source_data -> led_out_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] led_out_pio_s1_agent_rsp_fifo_out_data;                                      // led_out_pio_s1_agent_rsp_fifo:out_data -> led_out_pio_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> led_out_pio_s1_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> led_out_pio_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // led_out_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> led_out_pio_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> led_out_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> led_out_pio_s1_agent:cp_endofpacket
	...
	wire  [104:0] switch_in_pio_s1_agent_rf_source_data;                                       // switch_in_pio_s1_agent:rf_source_data -> switch_in_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] switch_in_pio_s1_agent_rsp_fifo_out_data;                                    // switch_in_pio_s1_agent_rsp_fifo:out_data -> switch_in_pio_s1_agent:rf_sink_data
	...
	wire          cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> switch_in_pio_s1_agent:cp_valid
	wire  [103:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> switch_in_pio_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                       // switch_in_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> switch_in_pio_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> switch_in_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> switch_in_pio_s1_agent:cp_endofpacket
	...
	wire  [103:0] nios2_jtag_debug_module_agent_rp_data;                                       // nios2_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire          led_out_pio_s1_agent_rp_valid;                                               // led_out_pio_s1_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] led_out_pio_s1_agent_rp_data;                                                // led_out_pio_s1_agent:rp_data -> router_005:sink_data
	wire          led_out_pio_s1_agent_rp_ready;                                               // router_005:sink_ready -> led_out_pio_s1_agent:rp_ready
	wire          led_out_pio_s1_agent_rp_startofpacket;                                       // led_out_pio_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          led_out_pio_s1_agent_rp_endofpacket;                                         // led_out_pio_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          switch_in_pio_s1_agent_rp_valid;                                             // switch_in_pio_s1_agent:rp_valid -> router_006:sink_valid
	wire  [103:0] switch_in_pio_s1_agent_rp_data;                                              // switch_in_pio_s1_agent:rp_data -> router_006:sink_data
	wire          switch_in_pio_s1_agent_rp_ready;                                             // router_006:sink_ready -> switch_in_pio_s1_agent:rp_ready
	wire          switch_in_pio_s1_agent_rp_startofpacket;                                     // switch_in_pio_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          switch_in_pio_s1_agent_rp_endofpacket;                                       // switch_in_pio_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] router_004_src_channel;                                                      // router_004:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [4:0] sdram_s1_rsp_width_adapter_src_channel;                                      // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire    [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire          led_out_pio_s1_agent_rdata_fifo_src_valid;                                   // led_out_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] led_out_pio_s1_agent_rdata_fifo_src_data;                                    // led_out_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          led_out_pio_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_003:in_0_ready -> led_out_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> led_out_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> led_out_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                           // led_out_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> led_out_pio_s1_agent:rdata_fifo_sink_error
	wire          switch_in_pio_s1_agent_rdata_fifo_src_valid;                                 // switch_in_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] switch_in_pio_s1_agent_rdata_fifo_src_data;                                  // switch_in_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          switch_in_pio_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_004:in_0_ready -> switch_in_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> switch_in_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> switch_in_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                           // switch_in_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> switch_in_pio_s1_agent:rdata_fifo_sink_error
	...
	cpen391_group5_qsys_mm_interconnect_0_router_001 router_001 (
	...
	cpen391_group5_qsys_mm_interconnect_0_router_003 router_003 (
	...
	cpen391_group5_qsys_mm_interconnect_0_router_004 router_004 (
	...
	cpen391_group5_qsys_mm_interconnect_0_router_002 router_005 (
	...
	cpen391_group5_qsys_mm_interconnect_0_router_002 router_006 (
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clocks_sys_clk_clk),                        //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clocks_sys_clk_clk),                        //       clk.clk
		.reset               (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clocks_sys_clk_clk),                        //       clk.clk
		.reset               (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clocks_sys_clk_clk),                        //       clk.clk
		.reset               (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clocks_sys_clk_clk),                        //       clk.clk
		.reset               (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clocks_sys_clk_clk),                        //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clocks_sys_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clocks_sys_clk_clk),                        //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clocks_sys_clk_clk),                        //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clocks_sys_clk_clk),                        //       clk.clk
		.reset               (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpen391_group5_qsys_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),

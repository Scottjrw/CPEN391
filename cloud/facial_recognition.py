...
def applet():
	if request.method == 'POST':
	    ...
	    request_name = "https://maker.ifttt.com/trigger/%s/with/key/egyN_jF6pzR88s9b8rFg0jTYXbbIpEGH-rB_zGobz_i" % request.form['applet']
	    print("https://maker.ifttt.com/trigger/%s/with/key/egyN_jF6pzR88s9b8rFg0jTYXbbIpEGH-rB_zGobz_i" % request.form['applet'])
